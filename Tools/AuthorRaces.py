...
RANKS = {
    ...
    "elite":    {"label": "Elite",    "color": [0.05, 0.45, 1.00], "health": 1.60, "damage": 1.25, "size": 1.10, "skillBonus": 1,
                 "armorTint": 0.80, "bodyTint": 0.12, "glow": 1.1, "rim": 0.80, "classification": "elite",
    ...
    "champion": {"label": "Champion", "color": [0.70, 0.22, 1.00], "health": 2.20, "damage": 1.40, "size": 1.18, "skillBonus": 1,
                 "armorTint": 0.90, "bodyTint": 0.14, "glow": 1.4, "rim": 0.95, "classification": "elite",
                 "note": "WoW epic purple: purple armour and trim glow, larger, one extra skill."},
    "warlord":  {"label": "Warlord",  "color": [1.00, 0.24, 0.00], "health": 1.00, "damage": 1.00, "size": 1.00, "skillBonus": 2,
                 "armorTint": 0.55, "bodyTint": 0.06, "glow": 0.8, "rim": 0.80, "classification": "boss",
                 "note": "WoW legendary orange: every boss. Stats come from the boss archetype; two extra skills."},
    "mythic":   {"label": "Mythic",   "color": [0.95, 0.05, 0.03], "trim": [1.00, 0.12, 0.06], "health": 1.50, "damage": 1.30, "size": 1.12,
                 "skillBonus": 3, "armorTint": 0.70, "bodyTint": 0.20, "glow": 1.2, "rim": 1.10, "classification": "boss",
                 "note": "Blood-red body with an ember trim: late-cycle bosses and hand-placed terrors; three extra skills."},
}
...
VISUALS = {
    ...
    "npc_silenced": vis("Silenced", "debuff", "arcane", [0.72, 0.4, 1.0], [0.3, 0.1, 0.5], [0.95, 0.85, 1.0],
                        [{"shape": "glyph", "attach": "overhead", "style": "eye", "size": 0.9}, {"shape": "ring", "attach": "ground", "style": "dashed", "count": 6, "speed": 0.8}],
    ...
    "npc_runic": vis("Runebound", "debuff", "arcane", [0.3, 0.6, 1.0], [0.1, 0.25, 0.6], [0.85, 0.95, 1.0],
                     [{"shape": "crystals", "attach": "body", "count": 6, "speed": 0.5}, {"shape": "ring", "attach": "ground", "style": "runes", "count": 8, "speed": 0.6}],
