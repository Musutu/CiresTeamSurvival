...
MODELS = {
    "island_tree_01": ("1k", "fields, hornbeam", "broadleaf trees along the field edge and around the glade"),
    "tree_small_02": ("1k", "fields, hornbeam", "young trees, glade understorey"),
    "rusted_spade_01": ("1k", "fields", "farm tool leaning on a bale"),
    "hatchet": ("1k", "fields", "farm clutter"),
    "coast_rocks_01": ("1k", "iceland", "black shoreline rocks"),
    "coast_rocks_05": ("1k", "iceland", "shoreline rock cluster"),
    "coastal_cliff_02": ("1k", "iceland", "sea-cliff backdrop"),
    "coast_land_rocks_02": ("1k", "iceland", "low lava outcrops"),
    "moss_01": ("1k", "iceland, hornbeam", "moss cushions on lava and logs"),
    "sand_rocks_small_01": ("1k", "iceland, underwater", "pebble scatter"),
    "namaqualand_cliff_01": ("1k", "moab", "sandstone ledges (red-tinted)"),
    "namaqualand_cliff_02": ("1k", "moab", "canyon wall faces (red-tinted)"),
    "namaqualand_boulder_03": ("1k", "moab", "fallen sandstone blocks"),
    "namaqualand_boulder_05": ("1k", "moab", "sandstone boulder"),
    "namaqualand_boulders_01": ("1k", "moab", "boulder pair"),
    "namaqualand_rocks_01": ("1k", "moab", "rock scatter"),
    "wild_rooibos_bush": ("1k", "moab", "desert scrub"),
    "dead_quiver_branch_01": ("1k", "moab", "dead juniper branches"),
    ...
    "shrub_01": ("1k", "hornbeam", "flowering undergrowth"),
    ...
    "old_military_crate": ("1k", "station", "cargo crates"),
    "industrial_storage_cart": ("1k", "station", "cargo cart"),
    "portable_searchlight": ("1k", "station", "deck floodlights"),
    "overhead_crane": ("1k", "station", "gantry crane"),
    "concrete_road_barrier": ("1k", "station", "deck barriers"),
...
TEXTURES = {
    ...
    "sparse_grass": ("fields", "field margins"),
    ...
    "forest_leaves_02": ("hornbeam", "mossy glade floor"),
