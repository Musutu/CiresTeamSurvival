...
BINDINGS = [
    ...
    {"profileId": "huntress", "status": "custom_ready", "motion": "mounted",
     "mesh": "/Game/Free/Creatures/Wolf/Wolf/SkeletalMeshes/Wolf.Wolf", "heightCm": 150, "yaw": -90, "lockRoot": True,
     ...
     "tint": {"base": [0.09, 0.07, 0.065], "accent": [0.55, 0.12, 0.08], "strength": 0.8},
