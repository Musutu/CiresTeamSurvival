...
KIT_SIGNATURES = {
    ...
    "bear_maul": ("Gravewood Maul", ["tank"], "active", "physical", "enemy", 0, 0, 20, 8, 60, "damage", 280, 0, 3,
                  "Heavy claw strike for {effect} damage: triple threat, and the target is taunted for 3s.",
                  [fx("taunt", "target", 3)], {"section": "attack"}),
    "bear_roar": ("Deepwood Roar", ["tank"], "active", "physical", "aim", 0, 0, 25, 12, 30, "damage", 550, 550, 4,
    ...
    "bear_charge": ("Rootbreaker Charge", ["tank"], "active", "physical", "aim", 0, 0, 30, 14, 55, "damage", 750, 90, 1,
    ...
    "bear_colossus": ("Elder of the Deepwood", ["tank"], "ultimate", "physical", "self", 0, 0, 50, 80, 140, "damage", 0, 600, 12,
    ...
    # ================================================================ Paladins
    "paladin_righteous_flail": ("Righteous Flail", ["tank"], "active", "holy", "aim", 0, 0, 25, 9, 55, "damage", 420, 420, 6,
    ...
    "paladin_holy_flail": ("Merciful Censer", ["heal"], "active", "holy", "enemy", 0, 30, 0, 8, 70, "damage", 320, 450, 0,
                           "Strike an enemy with the censer for {effect} holy damage; the impact releases a healing pulse that restores allies within 4.5m of the target for 60% of the damage dealt.",
                           [], {"section": "spell"}),
    "paladin_pilgrim_light": ("Pilgrim Light", ["heal"], "active", "holy", "aim", 1.0, 40, 0, 7, 110, "healing", 1100, 60, 0,
    ...
    "miner_pickfall": ("Pickfall", ["tank"], "active", "earth", "enemy", 0, 0, 20, 8, 55, "damage", 280, 0, 5,
    ...
    "miner_faultline": ("Faultline", ["tank"], "active", "earth", "aim", 0, 0, 30, 12, 70, "damage", 900, 110, 2,
    ...
    "miner_mountain": ("Heart of the Mountain", ["tank"], "ultimate", "earth", "aim", 0, 0, 50, 80, 140, "damage", 800, 500, 6,
    ...
    # ================================================================ Ether Golems
    "golem_granite_fist": ("Granite Fist", ["tank"], "active", "earth", "aim", 0, 0, 25, 9, 60, "damage", 450, 450, 2,
    ...
    "golem_ether_anchor": ("Ether Anchor", ["tank"], "active", "arcane", "aim", 0, 0, 25, 14, 40, "damage", 800, 250, 2,
    ...
    "golem_construct_core": ("Construct Core", ["tank", "dps"], "passive", "arcane", "passive", 0, 0, 0, 0, 2, "% per charge", 0, 0, 6,
                             ...
                             [], {"curve": {"effectCap": 4}}),
    "golem_worldstone": ("Worldstone Awakened", ["tank", "heal", "dps"], "ultimate", "arcane", "self", 0, 0, 50, 85, 120, "damage or healing", 0, 600, 10,
    ...
    "golem_moss_bloom": ("Verdant Bloom", ["heal"], "active", "nature", "aim", 1.5, 55, 0, 14, 28, "healing per second", 900, 350, 6,
    ...
    "golem_living_granite": ("Living Granite", ["heal"], "active", "nature", "ally", 1.0, 45, 0, 10, 120, "barrier health", 1100, 0, 8,
                             "Cast 1s: cover an ally in living granite: a {effect} barrier for 8s; while it holds they regenerate 1.5% of their max health per second.",
                             [fx("shield", "target", 8, label="Living Granite")], {"scaling": S("shield", 120, 2.5), "section": "defensive"}),
    "golem_fel_fist": ("Felfire Fist", ["dps"], "active", "fire", "aim", 0, 0, 25, 8, 75, "damage", 400, 400, 3,
    ...
    "chieftain_axe_hook": ("Chieftain Hook", ["tank"], "active", "physical", "aim", 0, 0, 30, 12, 50, "damage", 900, 50, 2,
    ...
    "behemoth_totem_sweep": ("Totem Sweep", ["tank"], "active", "earth", "aim", 0, 0, 25, 9, 60, "damage", 450, 450, 2,
    ...
    "behemoth_tusk_line": ("Tuskbreaker", ["tank"], "active", "earth", "aim", 0, 0, 30, 14, 65, "damage", 800, 100, 1.5,
    ...
    "behemoth_ancestral_weight": ("Ancestral Weight", ["tank"], "passive", "earth", "passive", 0, 0, 0, 0, 15, "% damage reduction", 0, 0, 0,
                                  ...
                                  [], {"curve": {"effectCap": 25}}),
    "behemoth_stampede": ("Ancestral Stampede", ["tank"], "ultimate", "earth", "aim", 0, 0, 50, 80, 150, "damage", 1200, 200, 1,
    ...
    "drakish_dragon_oath": ("Dragon Oath", ["tank"], "active", "fire", "self", 0, 0, 35, 16, 60, "damage per slash", 1200, 350, 6,
    ...
    "drakish_wing_rebuke": ("Wing Rebuke", ["tank"], "active", "fire", "aim", 0, 0, 25, 12, 45, "damage", 400, 400, 0,
    ...
    "drakish_ember_memory": ("Ember Memory", ["tank"], "passive", "fire", "passive", 0, 0, 0, 0, 20, "% of the hit as burn", 0, 0, 3,
                             ...
                             [], {"curve": {"effectCap": 35}}),
    "drakish_ancient_pact": ("Ancient Pact", ["tank"], "ultimate", "fire", "self", 0, 0, 50, 80, 130, "damage", 0, 500, 10,
    ...
    "troll_axe_frenzy": ("Axe Frenzy", ["dps"], "active", "physical", "enemy", 0, 0, 30, 9, 30, "damage per hit", 280, 0, 1.2,
    ...
    "troll_blood_leap": ("Bloodbound Leap", ["dps"], "active", "physical", "aim", 0, 0, 30, 12, 70, "damage", 700, 300, 0,
    ...
    "troll_twin_throw": ("Twin Throw", ["dps"], "active", "physical", "aim", 0, 0, 25, 7, 70, "damage per axe", 1300, 30, 0,
    ...
    "troll_returning_axes": ("Returning Axes", ["dps"], "active", "physical", "aim", 0, 0, 30, 11, 55, "damage per pass", 1100, 70, 0,
    ...
    # ================================================================ Whisp (support, INT)
    "whisp_guiding_mote": ("Guiding Mote", ["heal"], "active", "arcane", "aim", 1.0, 35, 0, 6, 100, "healing", 1200, 60, 0,
                           ...
                           [], {}),
    "whisp_spirit_tether": ("Spirit Tether", ["heal"], "active", "arcane", "ally", 0.5, 45, 0, 12, 30, "healing per second", 700, 0, 6,
    ...
    "whisp_constellation": ("Kindred Constellation", ["heal"], "ultimate", "arcane", "self", 1.5, 120, 0, 85, 60, "healing per pulse", 0, 900, 8,
    ...
    "centaur_grove_javelin": ("Grove Javelin", ["heal", "dps"], "active", "nature", "aim", 0, 35, 0, 8, 80, "damage", 1300, 30, 3,
                              "Hurl a root-tipped javelin: the first enemy hit takes {effect} damage and a healing bloom (2.5m) grows there for 3s, healing allies inside for 50% of the damage.",
                              [], {"section": "spell"}),
    ...
    "centaur_spring_march": ("Spring March", ["heal"], "ultimate", "nature", "self", 1.0, 110, 0, 80, 30, "healing per second", 0, 600, 8,
    ...
    "keeper_dawn_beam": ("Dawn Beam", ["heal"], "active", "holy", "aim", 1.2, 45, 0, 9, 110, "healing", 1000, 100, 4,
    ...
    "keeper_beacon": ("Beacon of Return", ["heal"], "active", "holy", "aim", 0, 35, 0, 16, 25, "% move speed", 1000, 400, 8,
                      "Raise a Beacon of Return (4m) for 8s: allies inside move {effect}% faster and regenerate 1% of their max health per second.",
    ...
    "keeper_sunrise": ("Sunrise Vigil", ["heal"], "ultimate", "holy", "self", 2.0, 130, 0, 90, 40, "healing per second", 0, 900, 6,
