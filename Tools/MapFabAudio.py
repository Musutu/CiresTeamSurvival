...
RULES: "OrderedDict[str, list]" = OrderedDict([
    ...
    ("spell.physical.projectile", [(MS, r"Wind_Loop_1_wav")]),
    ("spell.earth.projectile", [(MS, r"Wind_Loop_1_wav")]),
    ("weapon.glaive.spin", [(MS, r"Wind_Loop_1_wav")]),
    ("weapon.axe.spin", [(MS, r"Wind_Loop_1_wav")]),
