"""champion-hq: open the vendor Tripo Bridge panel and keep saving its imports until Saved/TripoBridgeHQStop.request appears.
...
Create Saved/TripoBridgeHQStop.request to save and exit cleanly. The map is never saved.
"""
...
stop_file = project / "Saved" / "TripoBridgeHQStop.request"
subsystem = unreal.get_editor_subsystem(unreal.EditorUtilitySubsystem)
subsystem.spawn_registered_tab_by_id("TripoWebSocketTab")
unreal.log("CIRE_TRIPO_BRIDGE_OPEN: champion-hq watcher active")
