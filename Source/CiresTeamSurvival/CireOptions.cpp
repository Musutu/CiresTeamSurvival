...
void ACireHUD::DrawSettings()
{
    ...
    else if(OptionsTab==2)
    {
        ...
        Slider(TEXT("Ground telegraph intensity"),UISettings.GroundTelegraphIntensity,.3f,1,.05f,R,Top+242,TEXT("Brightness of ground telegraphs, aim previews and lingering zones (fill, rim and runes). Enemy warnings stay readable at the lowest setting.")); // ability-vfx
